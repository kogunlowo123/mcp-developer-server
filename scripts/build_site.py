...
REPOSITORY_URL: Final[str] = "https://github.com/kogunlowo123/mcp-developer-server"
...
PAGES: Final[tuple[Page, ...]] = (
    ...
    Page(Path("docs/protocol.md"), "protocol", "The protocol", "Reference"),
    Page(Path("docs/tools.md"), "tools", "The tools", "Reference"),
    Page(Path("docs/configuration.md"), "configuration", "Configuration", "Reference"),
    Page(Path("docs/conformance.md"), "conformance", "Conformance", "Reference"),
...
<div class="layout">
<nav class="sidebar">
<h1><a href="index.html">MCP Developer Server</a></h1>
        ...
        (output / page.output_name).write_text(
            TEMPLATE.format(
                title=html.escape(
                    ...
                    if page.slug == "index"
                    else f"{page.title} — MCP Developer Server"
                ),
